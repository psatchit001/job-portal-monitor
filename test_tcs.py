"""
Run this to scrape only TCS and see every job detail in the terminal.
...
async def main():
    ...
    async with async_playwright() as pw:
        ...
        print("\n[1/3] Launching Playwright browser and navigating to TCS careers...\n")
    ...
    print(DIVIDER)
    print(f"\n  SUMMARY")
    print(f"  Total jobs scraped from TCS        : {len(all_jobs)}")
    ...
    if matched:
        ...
        print("  Check debug/tcs_rendered.html to inspect the raw page HTML.")
