"""
Run this to scrape only Texas Instruments and see every job detail in the terminal.
...
async def main():
    ...
    print(DIVIDER)
    print("  Texas Instruments — Job Scraper Test")
    print(DIVIDER)
    ...
    async with async_playwright() as pw:
        ...
        print("\n[1/3] Launching Playwright browser and navigating to TI careers...\n")
    ...
    # ── Filter to Software / AI / ML related roles ─────────────────────────
    ...
    # ── Run semantic matcher on filtered set ────────────────────────────────
    ...
    print(DIVIDER)
    print(f"\n  SUMMARY")
    print(f"  Total jobs scraped from TI      : {len(all_jobs)}")
    ...
    if matched:
        ...
        print("  Check debug/ti_rendered.html to inspect the raw page HTML.")
