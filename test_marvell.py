"""
Run this to scrape only Marvell and see every job detail in the terminal.

Usage:
    python test_marvell.py
"""
import asyncio
import sys
import os
...
async def main():
    ...
    print(DIVIDER)
    print("  Marvell -- Job Scraper Test")
    print(DIVIDER)
    ...
    async with async_playwright() as pw:
        ...
        print("\n[1/3] Launching Playwright browser and navigating to Marvell careers...\n")
    ...
    print(DIVIDER)
    print(f"\n  SUMMARY")
    print(f"  Total jobs scraped from Marvell    : {len(all_jobs)}")
    ...
    if matched:
        ...
        print("  Check debug/marvell_rendered.html to inspect the raw page HTML.")
