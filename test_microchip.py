"""
Run this to scrape only Microchip Technology and see every job detail in the terminal.

Usage:
    python test_microchip.py
"""
import asyncio
import sys
import os
...
async def main():
    ...
    print(DIVIDER)
    print("  Microchip Technology -- Job Scraper Test")
    print(DIVIDER)
    ...
    async with async_playwright() as pw:
        ...
        print("\n[1/3] Launching Playwright browser and navigating to Microchip careers...\n")
    ...
    print(DIVIDER)
    print(f"\n  SUMMARY")
    print(f"  Total jobs scraped from Microchip  : {len(all_jobs)}")
    ...
    if matched:
        ...
        print("  Check debug/microchip_rendered.html to inspect the raw page HTML.")
