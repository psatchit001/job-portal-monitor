"""
Run this to scrape only Analog Devices and see every job detail in the terminal.

Usage:
    python test_analog_devices.py
"""
import asyncio
import sys
import os
...
async def main():
    scraper = AnalogDevicesScraper()

    print(DIVIDER)
    print("  Analog Devices -- Job Scraper Test")
    print(DIVIDER)
    ...
    async with async_playwright() as pw:
        ...
        print("\n[1/3] Launching Playwright browser and navigating to Analog Devices careers...\n")
    ...
    print(DIVIDER)
    print(f"\n  SUMMARY")
    print(f"  Total jobs scraped from Analog Devices : {len(all_jobs)}")
    ...
    if matched:
        ...
        print("  Check debug/analog_devices_rendered.html to inspect the raw page HTML.")
