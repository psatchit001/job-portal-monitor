"""
Run this to scrape only Cognizant and see every job detail in the terminal.

Usage:
    python test_cognizant.py
"""
import asyncio
import sys
import os
...
async def main():
    ...
    print(DIVIDER)
    print("  Cognizant -- Job Scraper Test")
    print(DIVIDER)
    ...
    async with async_playwright() as pw:
        ...
        print("\n[1/3] Launching Playwright browser and navigating to Cognizant careers...\n")
    ...
    print(DIVIDER)
    print(f"\n  SUMMARY")
    print(f"  Total jobs scraped from Cognizant  : {len(all_jobs)}")
    ...
    if matched:
        ...
        print("  Check debug/cognizant_rendered.html to inspect the raw page HTML.")
