"""
Run this to scrape only HCL Tech and see every job detail in the terminal.

Usage:
    python test_hcltech.py
"""
import asyncio
import sys
import os
...
async def main():
    ...
    print(DIVIDER)
    print("  HCL Tech -- Job Scraper Test")
    print(DIVIDER)
    ...
    async with async_playwright() as pw:
        ...
        print("\n[1/3] Launching Playwright browser and navigating to HCL Tech careers...\n")
    ...
    print(DIVIDER)
    print(f"\n  SUMMARY")
    print(f"  Total jobs scraped from HCL Tech   : {len(all_jobs)}")
    ...
    if matched:
        ...
        print("  Check debug/hcltech_rendered.html to inspect the raw page HTML.")
