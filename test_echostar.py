"""
Run this to scrape only EchoStar and see every job detail in the terminal.

Usage:
    python test_echostar.py
"""
import asyncio
import sys
import os
...
async def main():
    scraper = EchoStarScraper()

    print(DIVIDER)
    print("  EchoStar -- Job Scraper Test")
    print(DIVIDER)
    ...
    async with async_playwright() as pw:
        ...
        print("\n[1/3] Launching Playwright browser and navigating to EchoStar careers...\n")
    ...
    print(DIVIDER)
    print(f"\n  SUMMARY")
    print(f"  Total jobs scraped from EchoStar   : {len(all_jobs)}")
    ...
    if matched:
        ...
        print("  Check debug/echostar_rendered.html to inspect the raw page HTML.")
