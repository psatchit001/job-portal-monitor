"""
Run this to scrape only Emerson and see every job detail in the terminal.

Usage:
    python test_emerson.py
"""
import asyncio
import sys
import os
...
async def main():
    scraper = EmersonScraper()

    print(DIVIDER)
    print("  Emerson -- Job Scraper Test")
    print(DIVIDER)
    ...
    async with async_playwright() as pw:
        ...
        print("\n[1/3] Launching Playwright browser and navigating to Emerson careers...\n")
    ...
    print(DIVIDER)
    print(f"\n  SUMMARY")
    print(f"  Total jobs scraped from Emerson    : {len(all_jobs)}")
    ...
    if matched:
        ...
        print("  Check debug/emerson_rendered.html to inspect the raw page HTML.")
