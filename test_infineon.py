"""
Run this to scrape only Infineon and see every job detail in the terminal.

Usage:
    python test_infineon.py
"""
import asyncio
import sys
import os
...
async def main():
    scraper = InfineonScraper()

    print(DIVIDER)
    print("  Infineon -- Job Scraper Test")
    print(DIVIDER)
    ...
    async with async_playwright() as pw:
        ...
        print("\n[1/3] Launching Playwright browser and navigating to Infineon careers...\n")
    ...
    print(DIVIDER)
    print(f"\n  SUMMARY")
    print(f"  Total jobs scraped from Infineon   : {len(all_jobs)}")
    ...
    if matched:
        ...
        print("  Check debug/infineon_rendered.html to inspect the raw page HTML.")
