"""
Run this to scrape only Micron and see every job detail in the terminal.

Usage:
    python test_micron.py
"""
import asyncio
import sys
import os
...
async def main():
    ...
    async with async_playwright() as pw:
        ...
        print("\n[1/3] Launching Playwright browser and navigating to Micron careers...\n")
    ...
    print(DIVIDER)
    print(f"\n  SUMMARY")
    print(f"  Total jobs scraped from Micron     : {len(all_jobs)}")
    ...
    if matched:
        ...
        print("  Check debug/micron_rendered.html to inspect the raw page HTML.")
