"""
Run this to scrape only Samsung and see every job detail in the terminal.

Usage:
    python test_samsung.py
"""
import asyncio
import sys
import os
...
async def main():
    ...
    print(DIVIDER)
    print("  Samsung -- Job Scraper Test")
    print(DIVIDER)
    ...
    async with async_playwright() as pw:
        ...
        print("\n[1/3] Launching Playwright browser and navigating to Samsung careers...\n")
    ...
    print(DIVIDER)
    print(f"\n  SUMMARY")
    print(f"  Total jobs scraped from Samsung    : {len(all_jobs)}")
    ...
    if matched:
        ...
        print("  Check debug/samsung_rendered.html to inspect the raw page HTML.")
