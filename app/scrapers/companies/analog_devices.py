        ...
        for term in self.SEARCH_TERMS:
            try:
                ...
                if first:
                    ...
                    debug_path = os.path.join(DEBUG_DIR, "analog_devices_rendered.html")
                    with open(debug_path, "w", encoding="utf-8") as f:
                        f.write(html)
                    print(f"[Analog Devices] Saved rendered HTML -> {debug_path}  ({len(html):,} bytes)")
                    first = False
                ...
                for card in cards:
                    ...
                    if not href.startswith("http"):
                        href = f"https://analogdevices.wd1.myworkdayjobs.com{href}"
                ...
                print(f"[Analog Devices] term '{term}' failed: {e}")
